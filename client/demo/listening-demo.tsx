...
const QUESTIONS: AnyQuestion[] = [
  // 1. Multiple Choice  (Level 3 — Developing — Recount)
  {
    ...
    options: [
      ...
      "He is sick and wants to go home",
    ],
    correctIndex: 0,
  },
  ...
  // 4. Image Grid — "Point to the picture"  (Level 1 — Entering — Explain)
  {
    ...
    images: [
      ...
      { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Good_Food_Display_-_NCI_Visuals_Online.jpg/320px-Good_Food_Display_-_NCI_Visuals_Online.jpg", label: "Food", altText: "Food" },
    ],
    correctIndex: 0,
  },
