...
export const SESSION_THEMES: Record<SessionDomainKey, SessionTheme> = {
  listening: {
    ...
    primaryBtn:
      "bg-slate-900 hover:bg-slate-800 text-white dark:bg-sky-600 dark:hover:bg-sky-500",
  ...
  reading: {
    ...
    primaryBtn:
      "bg-slate-900 hover:bg-slate-800 text-white dark:bg-amber-700 dark:hover:bg-amber-600",
    chip: "border-border/70 bg-background text-foreground",
  ...
  writing: {
    ...
    primaryBtn:
      "bg-slate-900 hover:bg-slate-800 text-white dark:bg-violet-700 dark:hover:bg-violet-600",
    chip: "border-border/70 bg-background text-foreground",
